---
title: "Exploratory Data Analysis of Solar Energy Data"
author: "JBS"
format: html
toc: true
toc-location: left
...
The dataset under consideration comprises daily solar energy readings from various locations within a large facility or campus over the course of one year. Each location's solar energy data has been recorded, offering an invaluable resource for understanding energy consumption and production patterns. This report aims to provide an exploratory data analysis (EDA) of this dataset, uncovering key insights and trends. The data contains 365 rows and 64 columns, where each row represents a day, and each column (except for the DATE) represents a specific location or area within the facility. The columns include

-   DATE: The date of the recorded data.

-   SKH 1 (MANDIR) to SSS RJY 2: Locations or areas within the facility with their respective solar energy readings.
...
### Analysis of Daily and Weekly Heatmaps
